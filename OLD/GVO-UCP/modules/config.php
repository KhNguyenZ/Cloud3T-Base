...
class KNCMS
{
    ...
    {
        $this->ketnoi();
        $row = $this->ketnoi->query("SELECT * FROM `accounts` WHERE `Username` = '$user'")->fetch_array();
        return $row;
    }
...
function sendDiscordMessage($message) {
    ...
    $ch = curl_init('https://discord.com/api/webhooks/1246482719936876638/HRnWmsxX1lwiL64VCUfZaDoBXRhzfno8y1FursIjCx1z8OSnZr7Q3M_iRaHWUUr3z06I');
